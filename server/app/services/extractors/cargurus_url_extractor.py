...
class CarGurusUrlExtractor:
    ...
    async def extract_listing_ids(self, search_data: Dict[str, Any]) -> List[int]:
        """
    ...
    async def generate_detail_urls(self, listing_ids: List[int], search_params: Optional[Dict[str, Any]] = None) -> \
            List[str]:
        """
    ...
    async def extract_urls_from_search_file(self, search_file_path: str,
                                            search_params: Optional[Dict[str, Any]] = None) -> List[str]:
        """
        ...
        try:
            ...
            listing_ids = await self.extract_listing_ids(search_data)
            urls = await self.generate_detail_urls(listing_ids, search_params)
    ...
    async def extract_listings_summary(self, search_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
...
async def extract_detail_urls_from_file(search_file_path: str, output_file: Optional[str] = None,
                                        search_params: Optional[Dict[str, Any]] = None) -> List[str]:
    """
    ...
    urls = await extractor.extract_urls_from_search_file(search_file_path, search_params)
...
async def get_listing_parameters_from_search(search_data: Dict[str, Any]) -> Dict[str, str]:
    """
